...
namespace CustomControl
{
    public partial class AxisControl : UserControl
    {
        ...
        System.Diagnostics.Stopwatch ClickTimer;
        private void AxisControl_Clicked(object sender, System.Windows.Input.TouchEventArgs e)
        {
            ShadeRectangle_Selected.Visibility = Visibility.Visible;
            if (ClickTimer.ElapsedMilliseconds < 150) this.ShadeRectangle_Selected.Visibility = Visibility.Hidden;
